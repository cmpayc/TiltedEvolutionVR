...
#if TP_SKYRIMVR
    bool operator==(const RequestDeathStateChange& acRhs) const noexcept { return Id == acRhs.Id && OwnershipEpoch == acRhs.OwnershipEpoch && IsDead == acRhs.IsDead && IsBleedingOut == acRhs.IsBleedingOut && GetOpcode() == acRhs.GetOpcode(); }
#else
