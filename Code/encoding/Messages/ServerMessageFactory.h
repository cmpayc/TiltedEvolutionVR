...
struct ServerMessageFactory
{
    ...
    template <class T> static auto Visit(T&& func)
    {
        auto s_visitor = CreateMessageVisitor<
            ...
            NotifyWeatherChange, NotifySetWaypoint, NotifyRemoveWaypoint, NotifySetTimeResult, NotifyRemoveSpell, NotifyObjectTransform, NotifyObjectRemove, NotifyHandPose>;
